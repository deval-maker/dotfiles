...
alias other_exports='export LIBTORCH_USE_PYTORCH=1 && export LIBTORCH_BYPASS_VERSION_CHECK=1 && export AWS_DEFAULT_REGION=us-east-2'
alias other_exports_rl_train='export LD_LIBRARY_PATH=/home/deval/anaconda3/envs/rl_train/lib:/home/deval/anaconda3/envs/rl_train/lib/python3.10/site-packages/torch/lib:/home/deval/anaconda3/envs/rl_train/lib/python3.10/site-packages/nvidia/cuda_runtime/lib/:$LD_LIBRARY_PATH'
# 
...
alias epy_ts='export TASK_SCHEDULING_DIR=$QOOWA_DIR/src/task_scheduling_rl && export PYTHONPATH="$PYTHONPATH:$TASK_SCHEDULING_DIR/python/"'

alias setup_wt0='export QOOWA_DIR=/home/deval/code/qoowa && epy_ts && cd $TASK_SCHEDULING_DIR && conda activate rl_train && other_exports && other_exports_rl_train'
alias setup_wt1='export QOOWA_DIR=/home/deval/code/qoowa.worktrees/worktree_1 && epy_rl && cd $TASK_SCHEDULING_DIR && conda activate rl_train && other_exports && other_exports_rl_train'
